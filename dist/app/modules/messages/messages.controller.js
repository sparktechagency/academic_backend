...
const createMessages = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (req === null || req === void 0 ? void 0 : req.file) {
        req.body.imageUrl = (0, fileHelper_1.storeFile)('messages', (_a = req === null || req === void 0 ? void 0 : req.file) === null || _a === void 0 ? void 0 : _a.filename);
    }
...
const seenMessage = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    server_1.io.emit(user1Chat, ChatListUser1);
    server_1.io.emit(user2Chat, ChatListUser2);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
